       ...
       <div class="row">
           ...
           <small class="clearfix">
             ...
             <a href="http://projects.spring.io/spring-roo/"
                ...
                Spring Roo</a>
             <span data-th-text="|Â© ${r"${#calendars.format(#dates.createNow(),'yyyy')}"}|">
                &copy; 2016</span> â€? We <span class="glyphicon glyphicon-heart"></span>
             <a href="https://github.com/spring-projects/spring-roo/"
                data-th-title="${r"#{"}label_gotoGithub}"
                target="_blank">
                Open source</a>
             <span sec:authorize="isAuthenticated()"> â€? </span>
